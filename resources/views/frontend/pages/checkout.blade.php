                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="wsus__check_form">
                        <div class="d-flex">
                            ...
                            <a href="#" style="margin-left:auto;" class="common_btn" data-bs-toggle="modal" data-bs-target="#exampleModal">add
                                new address</a>
                        </div>
                        <div class="row">
        ...
        $(document).ready(function(){
            ...
            $('#submitCheckoutForm').on('click', function(e){
                ...
                if($('#shipping_method_id').val() === "") {
                    ...
                    showToast('error' ,'You have to agree website terms and conditions');
                } else {
                    $.ajax({
