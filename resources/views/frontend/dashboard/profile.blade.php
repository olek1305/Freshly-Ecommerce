                            ...
                            <div class="wsus__dash_pro_area">
                                <h4>basic information</h4>
                                    <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        @method('PUT')
                                        <div class="col-md-12">
                                            <div class="col-xl-2 col-sm-5 col-md-2 mb-5">
                                                <div class="wsus__dash_pro_img">
                                                    <img src="{{ Auth::user()->image ? asset(Auth::user()->image) : asset('frontend/assets/images/ts-2.jpg') }}" alt="photo" class="img-fluid w-100">
