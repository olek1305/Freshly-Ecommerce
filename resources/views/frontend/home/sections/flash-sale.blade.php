            ...
            <div class="col-xl-12">
                <div class="offer_time" style="background: url({{ asset('frontend/assets/images/flash_sell_bg.jpg')}})">
                    <div class="wsus__flash_coundown">
                        ...
                        <a class="common_btn" href="{{ route('flashSale.index') }}">see more <i class="fas fa-caret-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            @foreach($flashSaleItems as $item)
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        ...
                        @endif
                        <a class="wsus__pro_link" href="{{ route('productDetail.show', $product->slug) }}">
                        ...
                        <div class="wsus__product_details">
                            ...
                            @else
                                <p class="wsus__price">${{ $product->offer_price }}></p>
                            @endif
