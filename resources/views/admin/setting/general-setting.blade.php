<div class="tab-pane fade show active" id="general-setting" role="tabpanel" aria-labelledby="list-home-list">
        ...
        <div class="card-body">
            <form action="{{ route('admin.general-setting-update') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="map_url" value="{{ @$generalSettings->map_url }}">
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="timezone" id="" class="form-control select2">
                        <option value="">Select</option>
                        @foreach (config('settings.timezones_list') as $key => $timeZone)
