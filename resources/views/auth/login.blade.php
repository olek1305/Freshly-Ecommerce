<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <a href="{{ route('auth.github') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md
            ...
            transition ease-in-out duration-150 ml-2">
                {{ __('Github Login') }}
            </a>
        </div>
    </form>
