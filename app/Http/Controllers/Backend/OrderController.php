...
use App\DataTables\CancelledOrdersDataTable;
use App\DataTables\DeliveredOrdersDataTable;
use App\DataTables\DroppedOfOrdersDataTable;
...
class OrderController extends Controller
{
    ...
    public function droppedOfOrders(DroppedOfOrdersDataTable $dataTable)
    {
    ...
    public function cancelledOrders(CancelledOrdersDataTable $dataTable)
    {
