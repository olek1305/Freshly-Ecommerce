        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item has-icon" href="'.route('vendor.products-image-gallery.index',
                        ['product' => $query->id]).'">Image Gallery</a></li>
                    <li><a class="dropdown-item has-icon" href="'.route('vendor.products-variant.index',
                        ['product' => $query->id]).'">Variants</a></li>
                </ul>
            </div>';
            ...
            ->addColumn('type', function($query){
                return match ($query->product_type) {
                    ...
                    'featured_product' => '<i class="badge bg-warning">Featured Product</i>',
                    'top_product' => '<i class="badge bg-info">Top Product</i>',
                    'best_product' => '<i class="badge bg-danger">Top Product</i>',
            ...
            ->addColumn('status', function($query){
                ...
                $button = '<div class="form-check form-switch">
                    <input checked class="form-check-input change-status" type="checkbox"
                    id="flexSwitchCheckDefault" data-id="'.$query->id.'"></div>';
                } else {
                $button = '<div class="form-check form-switch">
